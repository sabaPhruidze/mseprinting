...
export default function CarouselData() {
  const caruselData = [
    ...
    {
      image: LABELS_PACKAGING,
      alt: "First Slide",
      title: "Zotac",
      text: "Graphics cards, mini PCs, and other gaming and computing devices.",
    },
    {
      image: MARKETING_SERVICES,
      alt: "First Slide",
      title: "Zotac",
      text: "Graphics cards, mini PCs, and other gaming and computing devices.",
    },
    {
      image: ONLINE_ORDERING,
      alt: "First Slide",
      title: "Zotac",
      text: "Graphics cards, mini PCs, and other gaming and computing devices.",
    },
